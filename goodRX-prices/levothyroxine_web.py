...
def fetch_drug_prices(url):
    ...
    time.sleep(3)
    lowest_price = driver.find_element_by_xpath('//*[@id="pharmacy-coupons"]/div[1]/div[2]/div/div/div[1]/div/div/span[2]').text
    highest_price = driver.find_element_by_xpath('//*[@id="__next"]/div/div[2]/div[1]/div[4]/div/div[3]/div/div[14]/div[2]/a/div[1]/div[2]/div/div/div[1]/div/div/span[2]').text
...
url = 'https://www.goodrx.com/synthroid'
