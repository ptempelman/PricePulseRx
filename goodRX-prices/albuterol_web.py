...
def fetch_drug_prices(url):
    ...
    price = driver.find_element_by_xpath('//*[@id="__next"]/div/div[2]/div[1]/div[5]/div/div[2]/div/div/div/div/div[1]/div/div[2]/div[1]/div/span[2]').text
    ...
    highest_price = driver.find_element_by_xpath('//*[@id="__next"]/div/div[2]/div[1]/div[6]/div/div[1]/div/div[15]/div[2]/a/div[1]/div[2]/div/div/div[1]/div/div/span[2]').text
    print('Get successfully!\n')
    name = driver.find_element_by_tag_name('h1').text
    time.sleep(10)
    driver.quit()
